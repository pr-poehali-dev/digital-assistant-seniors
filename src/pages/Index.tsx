...
const HERO_IMG = "https://cdn.poehali.dev/projects/69f301b7-9c24-4422-87d0-b70d7ca3f972/files/4e99a103-ef33-4c98-ae57-774f4a9d2fc9.jpg";
...
const reviews = [
  {
    ...
    avatar: "М",
    color: "bg-cyan-500",
    text: "Живу в Питере, мама в Казани. Раньше ночами не спала — боялась, что её обманут. Теперь знаю: у неё есть человек который всегда поможет. Она даже сама научилась записываться к врачу!",
    stars: 5,
  },
  {
    name: "Андрей В.",
    ...
    avatar: "А",
    color: "bg-purple-500",
    text: "Папа попался на удочку мошенников дважды. После подключения сервиса — ни одного случая за 8 месяцев. Специалист настроил фильтрацию и объяснил папе как распознавать обман.",
    stars: 5,
  },
  {
    name: "Светлана Р.",
    ...
    avatar: "С",
    color: "bg-green-500",
    text: "Мы с братом скинулись на «Семейный» тариф для бабушки. Она в восторге — говорит, что Алексей (её специалист) как внук. Помог разобраться с субсидией на коммуналку, сэкономили 4000 рублей в месяц.",
    stars: 5,
  },
];
